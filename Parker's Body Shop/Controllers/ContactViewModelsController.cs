...
namespace Parker_s_Body_Shop.Controllers
{
    ...
    {
        private ContactViewModelContext db = new ContactViewModelContext();
        ...
        public ActionResult Create([Bind(Include = "ContactViewModelId,SMTPUrl,ContactEmail,SMTPUser,SMTPPass")] ContactViewModel contactViewModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ContactViewModelId,SMTPUrl,ContactEmail,SMTPUser,SMTPPass")] ContactViewModel contactViewModel)
        {
            if (ModelState.IsValid)
            {
